      ...
      <div>
        ...
        <div className="LandingPage-section2">
          ...
          <div className="Section2-cards">
            <Row gutter={4}>
              <Col span={6}>
                  <CardWithIcon className="Section2-card"
                    img={Section2Fig1}
                    title={"DATA SET"}
        ...
        <div className="LandingPage-section3">
          <div className="Section3-text">
            ...
            <p>
              ...
              Discover the most efficient frameworks, models and hardware for your specific experiment in ont platform.
            </p>
          </div>
        ...
        <div className="LandingPage-section4">
          <div className="Section4-text">
            ...
            <p style={{color: 'white'}}>
              Use side by side comparisons, graphs, and tables to draw insights and make an informed decision on which tools to use.
              View all the important metrics on your inference to get an overall understanding and to and go deeper into the details.
            </p>
          </div>
