  ...
  render() {
    return(
      <div className="LandingPage-section7">
        ...
        <Col >
            <img style={{position:'absolute', marginLeft:'125px', marginTop:'50px'}} src={Image2}/>
          </Col>
