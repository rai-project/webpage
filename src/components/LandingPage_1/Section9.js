    ...
    return (
      <div className="LandingPage-section7">
        ...
        <Row >
          ...
          <Col >
            <img style={{ position: 'absolute', marginLeft: '125px', marginTop: '50px' }} src={Image4} alt="" />
          </Col>
          ...
          <h2 style={{ color: 'black', position: 'absolute', marginLeft: '785px', marginTop: '220px' }}>
            ...
            to use.</h2>
          <a class="buttonsec6" style={{ textAlign: 'left', position: 'absolute', marginLeft: '785px', marginTop: '385px' }} href="/Experiment">
