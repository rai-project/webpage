  ...
  render() {
    return(
      <div className="LandingPage-section6">
        ...
        <Col >
            <img style={{position:'absolute', marginLeft:'125px', marginTop:'50px'}} src={Image1}/>
          </Col>
        <h3 style={{ color:'white', position:'absolute', marginLeft:'785px', marginTop:'165px'}}>ONE PLATFORM</h3>
          ...
          <a class="buttonsec6" style={{textAlign: 'left', position:'absolute', marginLeft:'785px', marginTop:'385px'}} href="#">
           DISCOVER PLATFORM {" "} <Icon style={{ fontSize: 20 }}  size="large" type="arrow-right" /></a>
        </Row>
